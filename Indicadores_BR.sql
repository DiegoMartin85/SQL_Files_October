...
WITH (
	...
	ROWTERMINATOR = '0X0d0a', --este é o código do enter \r\n (terminador do Windows)
...
/*================================================
07) Variação MoM (Mes sobre Mes) da inadimplencia
==================================================*/
...
/*===========================================================================
08) Inadimplencia vs Selic (Média) nos ultimos 24 Meses - atividade dificil
============================================================================*/
